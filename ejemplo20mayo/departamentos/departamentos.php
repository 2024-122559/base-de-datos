...
<body class="bg-light">
  ...
  <div class="container mt-5">
    ...
    <h2 class="text-center mb-4 animate__animated animate__fadeInDown">Listado de Departamentos</h2>
    ...
    <div class="d-flex justify-content-center my-4">
      <button type="button" class="btn btn-success animate__animated animate__pulse animate__infinite" data-bs-toggle="modal" data-bs-target="#exampleModal">
          ...
          <tr class="animate__animated animate__fadeInUp" style="animation-delay: <?php echo $delay * 0.1; ?>s;">
            ...
            <td class="d-flex justify-content-center gap-2">
              <form action="crud_depa.php" method="post">
                ...
                <button type="submit" name="btn_eli" id="btn_eli" class="btn btn-outline-danger animate__animated animate__heartBeat animate__slow">
              ...
              <form action="form_depa.php" method="post">
                ...
                <button type="submit" name="btn_act" id="btn_act" class="btn btn-outline-success animate__animated animate__heartBeat animate__slow">
