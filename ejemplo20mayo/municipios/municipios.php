...
<body class="bg-light">
  ...
  <div class="container mt-5">
    ...
    <h2 class="text-center mb-4 animate__animated animate__fadeInDown">Listado de Municipios</h2>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="crud_muni.php" method="post">
              ...
              <label for="text_cod_depa" class="form-label">Codigo De Departamento</label>
