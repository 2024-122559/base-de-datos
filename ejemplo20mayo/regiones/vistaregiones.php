...
?>
  ...
  <div class="container mt-5">
    ...
    <h2 class="text-center mb-4 animate__animated animate__fadeInDown">Listado de Regiones</h2>

    <button type="button" 
            class="btn btn-primary animate__animated animate__pulse animate__infinite mb-3" 
        ...
        <tr class="animate__animated animate__fadeInUp" style="animation-delay: <?php echo $delay * 0.1; ?>s;">
          ...
          <td class="d-flex justify-content-center gap-2">
            <form action="crud_region.php" method="post">
              ...
              <button type="submit" name="btn_eliminar" id="btn_eliminar" class="btn btn-outline-danger animate__animated animate__heartBeat animate__slow">
            ...
            <form action="form_actualizar_region.php" method="post">
              ...
              <button type="submit" name="btn_editar" id="btn_editar" class="btn btn-outline-success animate__animated animate__heartBeat animate__slow">
    ...
    <div class="text-center mt-4">
      <a href="../index.php" class="btn btn-primary animate__animated animate__fadeInUp animate__slow">Regresar</a>
    </div>
